...
let
  ...
  baseExtensions =
    ...
    lib.mapAttrs (_n: lib.recurseIntoAttrs) {
      ...
      bierner.github-markdown-preview = callPackage ./bierner.github-markdown-preview { };
      ...
      garlicbreadcleric.pandoc-markdown-syntax = callPackage ./garlicbreadcleric.pandoc-markdown-syntax { };
      ...
      ms-vscode-remote.remote-ssh-edit = callPackage ./ms-vscode-remote.remote-ssh-edit { };
      ...
      zaaack.markdown-editor = callPackage ./zaaack.markdown-editor { };
